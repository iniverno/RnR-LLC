...
def setup_run_for_n_transactions(num, dump_interval=1):
  ...
  __start_transaction_counter = 0
  __end_transaction_counter = 0
  SIM_hap_register_callback("Core_Magic_Instruction", end_transaction_callback, "end_transaction_magic_call")
...
def setup_run_for_n_cycles(num, dump_interval=1):
  ...
  SIM_hap_register_callback("Core_Magic_Instruction", end_transaction_callback_time, "end_transaction_magic_call_time")
...
def register_xact_mem_callback():
  ...
  SIM_hap_register_callback("Core_Magic_Instruction", xact_mem_callback, "transaction_call")
  #SIM_hap_register_callback("Core_Exception", start_trap_callback, "transaction_call")
...
def end_transaction_callback_time(desc, cpu, val):
  ...
  if ((current_time - __start_time) > __run_time):
    SIM_hap_unregister_callback("Core_Magic_Instruction", end_transaction_callback_time, "end_transaction_magic_call_time")
    try:
...
def limit_image(image_obj, limit):
  ...
  if files_to_delete == []:
    SIM_hap_register_callback("Core_At_Exit", delete_files, "delete_files")
