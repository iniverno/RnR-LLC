...
const Message* MessageBuffer::peekAtHeadOfQueue() const
{
  ...
  //cout << "Peeking at head of queue " + m_name + " time: "  + int_to_string(g_eventQueue_ptr->getTime()) + "." << endl;
  assert(isReady());
...
{
//cout << "enqueue " + m_name + " time: " + int_to_string(g_eventQueue_ptr->getTime()) + "." << endl;
...
//cout << "enqueue " + m_name + " with arrival_time " + int_to_string(arrival_time) + " cur_time: " + int_to_string(g_eventQueue_ptr->getTime()) + "."<< endl;
