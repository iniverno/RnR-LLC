...
public:
  ...
  static int L2CacheSetsBits() { return L2_CACHE_NUM_SETS_BITS; }

  //VICTIM CACHE MACHINES
  static int VCacheBits() { return g_NUM_PROCESSORS_BITS; }
  static int numberOfVCache() { return g_NUM_PROCESSORS; }
  static int VCachePerChipBits() { return procsPerChipBits() ; } // L1s != processors not currently supported
  static int numberOfVCachePerChip() { return numberOfProcsPerChip(); } // L1s != processors not currently supported
  static int numberOfVCachePerChip(NodeID myNodeID) { return numberOfVCachePerChip(); }
  static int VCacheTransitionsPerCycle() { return L1CACHE_TRANSITIONS_PER_RUBY_CYCLE; }
 ...
 // static int memoryResponseLatency() { return MEMORY_RESPONSE_LATENCY_MINUS_2+(random() % 5); } 
    static int memoryResponseLatency() { return MEMORY_RESPONSE_LATENCY_MINUS_2; } 
