...
void L1Cache_Controller::a_issueGETS(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:459: ", addr);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:460: ", (out_msg).m_Destination);
;
...
void L1Cache_Controller::b_issueGETX(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      (out_msg).m_RequestorMachId = m_machineID;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:477: ", m_machineID);
;
      (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:479: ", addr);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:480: ", (out_msg).m_Destination);
;
      (out_msg).m_MessageSize = MessageSizeType_Control;
      (out_msg).m_L1CacheStateStr = (L1Cache_getStateStr(addr));
      (out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
...
void L1Cache_Controller::c_issueUPGRADE(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      (out_msg).m_RequestorMachId = m_machineID;
      (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:498: ", addr);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:499: ", (out_msg).m_Destination);
;
      (out_msg).m_MessageSize = MessageSizeType_Control;
      (out_msg).m_L1CacheStateStr = (L1Cache_getStateStr(addr));
      (out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
...
void L1Cache_Controller::f_issueGETINSTR(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      (out_msg).m_RequestorMachId = m_machineID;
      (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:515: ", addr);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:516: ", (out_msg).m_Destination);
;
      (out_msg).m_MessageSize = MessageSizeType_Control;
      (out_msg).m_L1CacheStateStr = (L1Cache_getStateStr(addr));
      (out_msg).m_Prefetch = ((*in_msg_ptr)).m_Prefetch;
...
void L1Cache_Controller::d_issuePUTX(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    (out_msg).m_RequestorMachId = m_machineID;
    (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:533: ", addr);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:534: ", (out_msg).m_Destination);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:535: ", (out_msg).m_DataBlk);
;
...
void L1Cache_Controller::q_issuePUTS(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    (out_msg).m_RequestorMachId = m_machineID;
    (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:569: ", addr);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:570: ", (out_msg).m_Destination);
;
    (out_msg).m_MessageSize = MessageSizeType_Data;
    (out_msg).m_L1CacheStateStr = (L1Cache_getStateStr(addr));
    ((*(m_chip_ptr->m_L1Cache_requestFromL1Cache_vec[m_version]))).enqueue(out_msg, L15_REQUEST_LATENCY);
...
void L1Cache_Controller::e_dataFromL1CacheToL2Cache(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:610: ", addr);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:611: ", (out_msg).m_Destination);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:612: ", (out_msg).m_DataBlk);
;
    (out_msg).m_MessageSize = MessageSizeType_Data;
...
void L1Cache_Controller::f_dataFromTBEToL2Cache(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      (out_msg).m_SenderMachId = m_machineID;
      (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:648: ", addr);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:649: ", (out_msg).m_Destination);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:650: ", (out_msg).m_DataBlk);
;
      (out_msg).m_MessageSize = MessageSizeType_Data;
      ((*(m_chip_ptr->m_L1Cache_responseFromL1Cache_vec[m_version]))).enqueue(out_msg, L15_REQUEST_LATENCY);
    }
...
void L1Cache_Controller::t_sendInvAckToL2Cache(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    (out_msg).m_SenderMachId = m_machineID;
    (((out_msg).m_Destination).add((map_L1CacheMachId_to_L2Cache(addr, m_machineID))));
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:663: ", addr);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:664: ", (out_msg).m_Destination);
;
    (out_msg).m_MessageSize = MessageSizeType_Control;
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:712: ", ((L1Cache_getL1CacheEntry(addr))).m_DataBlk);
;
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:719: ", ((L1Cache_getL1CacheEntry(addr))).m_DataBlk);
;
...
void L1Cache_Controller::u_writeDataToL1Cache(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:751: ", addr);
;
  }
}
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:775: ", addr);
;
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:795: ", addr);
;
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:811: ", addr);
;
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:820: ", addr);
;
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:828: ", addr);
;
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:837: ", addr);
;
  if (((((*(m_chip_ptr->m_L1Cache_L15cacheMemory_vec[m_version]))).isTagPresent(addr)) == (false))) {
    (((*(m_chip_ptr->m_L1Cache_L15cacheMemory_vec[m_version]))).allocate(addr));
  }
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:846: ", addr);
;
  if ((((*(m_chip_ptr->m_L1Cache_L1DcacheMemory_vec[m_version]))).isTagPresent(addr))) {
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:855: ", addr);
;
  {
    const CacheMsg* in_msg_ptr;
    in_msg_ptr = dynamic_cast<const CacheMsg*>(((*(m_chip_ptr->m_L1Cache_mandatoryQueue_vec[m_version]))).peek());
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:870: ", addr);
;
  if (((((*(m_chip_ptr->m_L1Cache_L1DcacheMemory_vec[m_version]))).isTagPresent(addr)) == (false))) {
    (((*(m_chip_ptr->m_L1Cache_L1DcacheMemory_vec[m_version]))).allocate(addr));
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:881: ", addr);
;
  if (((((*(m_chip_ptr->m_L1Cache_L1IcacheMemory_vec[m_version]))).isTagPresent(addr)) == (false))) {
    (((*(m_chip_ptr->m_L1Cache_L1IcacheMemory_vec[m_version]))).allocate(addr));
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:892: ", addr);
;
}
