      ...
      if ((((*(m_chip_ptr->m_L1Cache_responseToL1Cache_vec[m_version]))).isReady())) {
        {
          ...
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:308: ", ((*in_msg_ptr)).m_Address);
;
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:309: ", ((*in_msg_ptr)).m_Destination);
;
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:310: ", ((*in_msg_ptr)).m_SenderMachId);
;
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:311: ", m_machineID);
;
...
;
                                        ...
                                        cerr << "Runtime Error at ../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:323, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("Invalid L1 response type") << ", PID: " << getpid() << endl;
...
;
                        ...
                        cerr << "Runtime Error at ../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:326, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("A non-L2 cache sent a response to a L1 cache") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
      ...
      if ((((*(m_chip_ptr->m_L1Cache_requestToL1Cache_vec[m_version]))).isReady())) {
        {
          ...
          assert(in_msg_ptr != NULL);
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:336: ", ((*in_msg_ptr)).m_Address);
;
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:337: ", ((*in_msg_ptr)).m_Destination);
;
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:338: ", m_machineID);
;
...
;
                                            ...
                                            cerr << "Runtime Error at ../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:353, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("Invalid forwarded request type") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
...
;
                        ...
                        cerr << "Runtime Error at ../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:356, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("A non-L2 cache sent a request to a L1 cache") << ", PID: " << getpid() << endl;
char c; cerr << "press return to continue." << endl; cin.get(c); abort();
      ...
      if ((((*(m_chip_ptr->m_L1Cache_mandatoryQueue_vec[m_version]))).isReady())) {
        {
          ...
          assert(in_msg_ptr != NULL);
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:368: ", ((*in_msg_ptr)).m_Address);
;
          DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-L115cache.sm:369: ", m_machineID);
;
