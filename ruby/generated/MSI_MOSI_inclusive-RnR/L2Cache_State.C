...
string L2Cache_State_to_string(const L2Cache_State& obj)
{
  ...
  case L2Cache_State_L2_IPSS:
    return "L2_IPSS";
  case L2Cache_State_L2_INRM:
    return "L2_INRM";
  case L2Cache_State_L2_INRMZ:
    return "L2_INRMZ";
  case L2Cache_State_L2_NRMIT:
    return "L2_NRMIT";
  case L2Cache_State_L2_NRMIV:
    return "L2_NRMIV";
  case L2Cache_State_L2_INRS:
    return "L2_INRS";
  case L2Cache_State_L2_INRSZ:
    return "L2_INRSZ";
  case L2Cache_State_L2_INRSI:
    return "L2_INRSI";
  case L2Cache_State_L2_NRSIV:
    return "L2_NRSIV";
  case L2Cache_State_L2_NRS:
    return "L2_NRS";
  case L2Cache_State_L2_NRSS:
    return "L2_NRSS";
  case L2Cache_State_L2_NRMT:
    return "L2_NRMT";
  default:
...
L2Cache_State string_to_L2Cache_State(const string& str)
{
  if (false) {
    ...
    return L2Cache_State_L2_INRM;
  } else if (str == "L2_INRMZ") {
    return L2Cache_State_L2_INRMZ;
  } else if (str == "L2_NRMIT") {
    return L2Cache_State_L2_NRMIT;
  } else if (str == "L2_NRMIV") {
    return L2Cache_State_L2_NRMIV;
  } else if (str == "L2_INRS") {
    return L2Cache_State_L2_INRS;
  } else if (str == "L2_INRSZ") {
    return L2Cache_State_L2_INRSZ;
  } else if (str == "L2_INRSI") {
    return L2Cache_State_L2_INRSI;
  } else if (str == "L2_NRSIV") {
    return L2Cache_State_L2_NRSIV;
  } else if (str == "L2_NRS") {
    return L2Cache_State_L2_NRS;
  } else if (str == "L2_NRSS") {
    return L2Cache_State_L2_NRSS;
  } else if (str == "L2_NRMT") {
    return L2Cache_State_L2_NRMT;
  } else {
    WARN_EXPR(str);
