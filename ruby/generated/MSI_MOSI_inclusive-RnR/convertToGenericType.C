                  ...
                  if ((param_type == CoherenceRequestType_L1_DG)) {
                    ...
                    if ((param_type == CoherenceRequestType_WB_ACK)) {
                      ...
                      if ((param_type == CoherenceRequestType_EXE_ACK)) {
                        ...
                        DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-RnR-msg.sm:154: ", param_type);
;
                                                cerr << "Runtime Error at ../protocols/MSI_MOSI_inclusive-RnR-msg.sm:155, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << ("invalid CoherenceRequestType") << ", PID: " << getpid() << endl;
