...
void Directory_Controller::a_addRequestorToSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:302: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
  }
}
  ...
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      if (((((*in_msg_ptr)).m_Type == CoherenceRequestType_GETX) || (((*in_msg_ptr)).m_Type == CoherenceRequestType_PREFX))) {
        DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:315: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
        DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:316: ", ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).count()));
;
      ...
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:326: ", (out_msg).m_Address);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:327: ", (out_msg).m_DataBlk);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:328: ", (out_msg).m_NumPendingExtAcks);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:329: ", (out_msg).m_Destination);
;
...
void Directory_Controller::d_forwardRequestToOwner(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:345: ", (out_msg).m_Destination);
;
      ...
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:353: ", (out_msg).m_Address);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:354: ", (out_msg).m_NumPendingExtAcks);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:355: ", (out_msg).m_Destination);
;
...
void Directory_Controller::f_setOwnerToRequestor(const Address& addr)
{
  ...
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:366: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner);
;
}
...
void Directory_Controller::h_invToSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    in_msg_ptr = dynamic_cast<const RequestMsg*>(((*(m_chip_ptr->m_Directory_requestToDir_vec[m_version]))).peek());
    assert(in_msg_ptr != NULL);
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:377: ", ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).count()));
;
    if ((((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).count()) != (0))) {
      {
        RequestMsg out_msg;
        ...
        (out_msg).m_RequestorMachId = ((*in_msg_ptr)).m_RequestorMachId;
        DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:383: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
  ...
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:390: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
}
...
void Directory_Controller::l_writeRequestDataToMemory(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:401: ", ((*in_msg_ptr)).m_Address);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:402: ", ((*in_msg_ptr)).m_DataBlk);
;
  }
}
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:443: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner);
;
  ...
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:445: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
}
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:449: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner);
;
  ...
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:451: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
}
...
void Directory_Controller::u_removeRequestorFromSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    in_msg_ptr = dynamic_cast<const RequestMsg*>(((*(m_chip_ptr->m_Directory_requestToDir_vec[m_version]))).peek());
    assert(in_msg_ptr != NULL);
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:456: ", ((*in_msg_ptr)).m_RequestorMachId);
;
    ...
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:458: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
  }
}
...
void Directory_Controller::jja_addRequestorToSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).add((L2CacheMachIDToChipID(((*in_msg_ptr)).m_RequestorMachId))));
    ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Add = ((*in_msg_ptr)).m_Address;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:486: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
  }
}
...
void Directory_Controller::jjb_dataToRequestor(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      (((out_msg).m_Destination).add(((*in_msg_ptr)).m_RequestorMachId));
      (out_msg).m_DataBlk = ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_DataBlk;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:503: ", (out_msg).m_Address);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:504: ", (out_msg).m_DataBlk);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:505: ", (out_msg).m_NumPendingExtAcks);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:506: ", (out_msg).m_Destination);
;
      (out_msg).m_MessageSize = MessageSizeType_Data;
...
void Directory_Controller::jjd_forwardRequestToOwner(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ...
      (out_msg).m_RequestorMachId = ((*in_msg_ptr)).m_RequestorMachId;
      (((out_msg).m_Destination).add((map_L2ChipId_to_L2Cache((out_msg).m_Address, ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner))));
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:522: ", (out_msg).m_Destination);
;
      if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_GETX)) {
        (out_msg).m_NumPendingExtAcks = ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).count());
      } else {
      ...
      (out_msg).m_MessageSize = MessageSizeType_Control;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:530: ", (out_msg).m_Address);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:531: ", (out_msg).m_NumPendingExtAcks);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:532: ", (out_msg).m_Destination);
;
      ((*(m_chip_ptr->m_Directory_forwardedRequestFromDir_vec[m_version]))).enqueue(out_msg, DIRECTORY_LATENCY);
    }
  }
...
void Directory_Controller::jjf_setOwnerToRequestor(const Address& addr)
{
  ...
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:543: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner);
;
}
...
void Directory_Controller::jjh_invToSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    in_msg_ptr = dynamic_cast<const RequestMsg*>(((*(m_chip_ptr->m_Directory_prefRequestToDir_vec[m_version]))).peek());
    assert(in_msg_ptr != NULL);
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:554: ", ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).count()));
;
    if ((((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).count()) != (0))) {
      {
        RequestMsg out_msg;
        ...
        (out_msg).m_Type = CoherenceRequestType_INV;
        (out_msg).m_RequestorMachId = ((*in_msg_ptr)).m_RequestorMachId;
        DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:560: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
        (out_msg).m_Destination = (getMultiStaticL2BankNetDest(addr, ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers));
        (out_msg).m_MessageSize = MessageSizeType_Control;
        ((*(m_chip_ptr->m_Directory_forwardedRequestFromDir_vec[m_version]))).enqueue(out_msg, DIRECTORY_LATENCY);
  ...
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:567: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
}
...
void Directory_Controller::jjl_writeRequestDataToMemory(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(((*in_msg_ptr)).m_Address))).m_DataBlk = ((*in_msg_ptr)).m_DataBlk;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:578: ", ((*in_msg_ptr)).m_Address);
;
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:579: ", ((*in_msg_ptr)).m_DataBlk);
;
  }
}
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:620: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner);
;
  ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).add(((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner));
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:622: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
}
...
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:626: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner);
;
  ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).remove(((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_ProcOwner));
  DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:628: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
}
...
void Directory_Controller::jju_removeRequestorFromSharers(const Address& addr)
{
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    in_msg_ptr = dynamic_cast<const RequestMsg*>(((*(m_chip_ptr->m_Directory_prefRequestToDir_vec[m_version]))).peek());
    assert(in_msg_ptr != NULL);
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:633: ", ((*in_msg_ptr)).m_RequestorMachId);
;
    ((((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers).remove((L2CacheMachIDToChipID(((*in_msg_ptr)).m_RequestorMachId))));
    DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:635: ", ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_Sharers);
;
  }
}
  ...
  DEBUG_MSG(GENERATED_COMP, HighPrio,"executing");
  {
    ...
    assert(in_msg_ptr != NULL);
    {
      ResponseMsg out_msg;
        ...
        cerr << "Runtime Error at ../protocols/MSI_MOSI_inclusive-dir.sm:666, Ruby Time: " << g_eventQueue_ptr->getTime() << ": " << "assert failure" << ", PID: " << getpid() << endl;
...
;
      ...
      (((out_msg).m_Destination).add(((*in_msg_ptr)).m_RequestorMachId));
      (out_msg).m_DataBlk = ((((*(m_chip_ptr->m_Directory_directory_vec[m_version]))).lookup(addr))).m_DataBlk;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:673: ", (out_msg).m_Address);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:674: ", (out_msg).m_DataBlk);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:675: ", (out_msg).m_NumPendingExtAcks);
;
      DEBUG_SLICC(MedPrio, "../protocols/MSI_MOSI_inclusive-dir.sm:676: ", (out_msg).m_Destination);
;
      (out_msg).m_MessageSize = MessageSizeType_Data;
