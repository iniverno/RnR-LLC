...
L2Cache_Controller::L2Cache_Controller(Chip* chip_ptr, int version)
{
  ...
  s_profiler.possibleTransition(L2Cache_State_L2_NP, L2Cache_Event_PrefetchS);
  s_profiler.possibleTransition(L2Cache_State_L2_I, L2Cache_Event_PrefetchS);
  ...
  s_profiler.possibleTransition(L2Cache_State_L2_NP, L2Cache_Event_PrefetchX);
  s_profiler.possibleTransition(L2Cache_State_L2_I, L2Cache_Event_PrefetchX);
  s_profiler.possibleTransition(L2Cache_State_L2_IPS, L2Cache_Event_PrefData_ext_ack_0);
  s_profiler.possibleTransition(L2Cache_State_L2_IPS, L2Cache_Event_L1_GETS);
  s_profiler.possibleTransition(L2Cache_State_L2_IPS, L2Cache_Event_L1_GET_INSTR);
  s_profiler.possibleTransition(L2Cache_State_L2_IPS, L2Cache_Event_L1_GETX);
  s_profiler.possibleTransition(L2Cache_State_L2_IPS, L2Cache_Event_L2_INV);
  s_profiler.possibleTransition(L2Cache_State_L2_IPSS, L2Cache_Event_PrefData_ext_ack_0);
  s_profiler.possibleTransition(L2Cache_State_L2_IPSS, L2Cache_Event_Data_ext_ack_0);
  s_profiler.possibleTransition(L2Cache_State_L2_IPSS, L2Cache_Event_L2_INV);
  s_profiler.possibleTransition(L2Cache_State_L2_IPI, L2Cache_Event_PrefData_ext_ack_0);
  s_profiler.possibleTransition(L2Cache_State_L2_IPI, L2Cache_Event_Data_ext_ack_0);
  s_profiler.possibleTransition(L2Cache_State_L2_IPI, L2Cache_Event_L2_INV);
  ...
  s_profiler.possibleTransition(L2Cache_State_L2_ISZ, L2Cache_Event_L2_INV);
  s_profiler.possibleTransition(L2Cache_State_L2_ISZ, L2Cache_Event_Data_ext_ack_0);
