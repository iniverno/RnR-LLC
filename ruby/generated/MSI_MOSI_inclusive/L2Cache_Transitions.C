...
)
{
  ...
  case HASH_FUN(L2Cache_State_L2_IPSS, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_L2_IPSS, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_L2_IPSS, L2Cache_Event_L1_GETX):
  case HASH_FUN(L2Cache_State_L2_IPI, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_L2_IPI, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_L2_IPI, L2Cache_Event_L1_GETX):
  case HASH_FUN(L2Cache_State_L2_ISZ, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_L2_ISZ, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_L2_ISZ, L2Cache_Event_L1_GETX):
  ...
  case HASH_FUN(L2Cache_State_L2_IPI, L2Cache_Event_L2_INV):
  ...
  case HASH_FUN(L2Cache_State_L2_NP, L2Cache_Event_PrefetchS):
  case HASH_FUN(L2Cache_State_L2_I, L2Cache_Event_PrefetchS):
  {
    next_state = L2Cache_State_L2_IPS;
    ...
    jjj_recordCoreID(addr);
    ja_issuePREFETCH(addr);
    jjj_prefetchPC(addr);
  ...
  case HASH_FUN(L2Cache_State_L2_NP, L2Cache_Event_PrefetchX):
  case HASH_FUN(L2Cache_State_L2_I, L2Cache_Event_PrefetchX):
  {
    next_state = L2Cache_State_L2_IPX;
    if (!(*(m_chip_ptr->m_L2Cache_Pref_TBEs_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
    }
    qq_allocateL2CacheBlock(addr);
  ...
  case HASH_FUN(L2Cache_State_L2_IPS, L2Cache_Event_PrefData_ext_ack_0):
  {
    next_state = L2Cache_State_L2_S;
    ju_writePrefetchDataFromResponseQueueToL2Cache(addr);
    jj_deactiveBloom(addr);
    s_deallocatePrefTBE(addr);
    jo_popIncomingPrefResponseQueue(addr);
    return TransitionResult_Valid;
  }
  case HASH_FUN(L2Cache_State_L2_IPS, L2Cache_Event_L1_GETS):
  case HASH_FUN(L2Cache_State_L2_IPS, L2Cache_Event_L1_GET_INSTR):
  case HASH_FUN(L2Cache_State_L2_IPS, L2Cache_Event_L1_GETX):
  {
    next_state = L2Cache_State_L2_IPSS;
    set_setMRU(addr);
    setTimeLast(addr);
    jj_addAccess(addr);
    ww_profileMissNoDir(addr);
    t_sendUpgradePrefetch(addr);
    return TransitionResult_Valid;
  }
  case HASH_FUN(L2Cache_State_L2_IPS, L2Cache_Event_L2_INV):
  case HASH_FUN(L2Cache_State_L2_IPSS, L2Cache_Event_L2_INV):
  {
    next_state = L2Cache_State_L2_IPI;
    if (!(*(m_chip_ptr->m_L2Cache_responseFromL2Cache_vec[m_version])).areNSlotsAvailable(1)) {
      return TransitionResult_ResourceStall;
    }
    t_sendAckToInvalidator(addr);
  ...
  case HASH_FUN(L2Cache_State_L2_IPSS, L2Cache_Event_PrefData_ext_ack_0):
  {
    next_state = L2Cache_State_L2_S;
    ju_writePrefetchDataFromResponseQueueToL2Cache(addr);
    jj_deactiveBloom(addr);
    s_deallocatePrefTBE(addr);
    jj_removeAccess(addr);
    jo_popIncomingPrefResponseQueue(addr);
    return TransitionResult_Valid;
  }
  case HASH_FUN(L2Cache_State_L2_IPSS, L2Cache_Event_Data_ext_ack_0):
  {
    next_state = L2Cache_State_L2_S;
  ...
  case HASH_FUN(L2Cache_State_L2_IPI, L2Cache_Event_PrefData_ext_ack_0):
  {
  ...
  case HASH_FUN(L2Cache_State_L2_IPI, L2Cache_Event_Data_ext_ack_0):
  {
    next_state = L2Cache_State_L2_I;
    u_writeDataFromResponseQueueToL2Cache(addr);
    jj_deactiveBloom(addr);
  ...
  case HASH_FUN(L2Cache_State_L2_ISZ, L2Cache_Event_L2_INV):
  {
  ...
  case HASH_FUN(L2Cache_State_L2_ISZ, L2Cache_Event_Data_ext_ack_0):
  {
