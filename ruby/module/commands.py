...
def ruby_print_temp(obj):
    SIM_set_attribute(obj, "print-temp", 0)
       
new_command("print-temp", ruby_print_temp,
            args = [],
            type = "multifacet commands",
            namespace = "ruby",
            short = "print life-temporal stuff",
            doc = """
<b>print-temp</b> print life-temporal stuff
""")

def ruby_reset_temp(obj):
    SIM_set_attribute(obj, "reset-temp", 0)
       
new_command("reset-temp", ruby_reset_temp,
            args = [],
            type = "multifacet commands",
            namespace = "ruby",
            short = "reset life-temporal stuff",
            doc = """
<b>print-temp</b> reset life-temporal stuff
""")

def ruby_print_reuse(obj):
    SIM_set_attribute(obj, "print-reuse", 0)
       
new_command("print-reuse", ruby_print_reuse,
            args = [],
            type = "multifacet commands",
            namespace = "ruby",
            short = "print reuse stuff",
            doc = """
<b>print-temp</b> print life-temporal stuff
""")

def ruby_reset_reuse(obj):
    SIM_set_attribute(obj, "reset-reuse", 0)
       
new_command("reset-reuse", ruby_reset_reuse,
            args = [],
            type = "multifacet commands",
            namespace = "ruby",
            short = "reset reuse stuff",
            doc = """
<b>print-temp</b> reset life-temporal stuff
""")