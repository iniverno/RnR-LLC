...
//JORGE
  int64 getL2Accesos();
  void addL1PrefInv( int id, bool inst);
  void addL1Acceso(const CacheMsg& msg, NodeID id);
...
private:
  // Private Methods
//JORGE
  void addL1DAcceso(const CacheMsg& msg, NodeID id);
  void addL1IAcceso(const CacheMsg& msg, NodeID id);
  void addL2Acceso(const CacheMsg& msg, NodeID id);
  ...
  CacheProfiler* m_L15_cache_profiler_ptr;
