...
#ifndef NRUPolicyL2_3SETi_H
#define NRUPolicyL2_3SETi_H

#include "AbstractReplacementPolicy.h"

/* Simple true NRU replacement policy */

class NRUPolicyL2_3SETi : public AbstractReplacementPolicy {
 public:

  NRUPolicyL2_3SETi(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  NRUPolicyL2_3SETi(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a);
  ~NRUPolicyL2_3SETi();
...
inline
NRUPolicyL2_3SETi::NRUPolicyL2_3SETi(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
...
inline
NRUPolicyL2_3SETi::NRUPolicyL2_3SETi(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}

inline
NRUPolicyL2_3SETi::~NRUPolicyL2_3SETi()
{
}

inline 
void NRUPolicyL2_3SETi::touch(Index set, Index index, Time time){
...
inline
Index NRUPolicyL2_3SETi::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline void NRUPolicyL2_3SETi::replacementLower(Index set, Index way) const {
}

inline 
bool NRUPolicyL2_3SETi::subSet(L2Cache_Entry *a, uint set) const
{
...
inline 
uint NRUPolicyL2_3SETi::whatSubSet(L2Cache_Entry &a) const
{
...
inline
void NRUPolicyL2_3SETi::printStats(ostream& out, char* name)  const
{ int a=0;}

inline
void NRUPolicyL2_3SETi::printStats(ostream& out)  const
{ int a=0;}
