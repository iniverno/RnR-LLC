...
#ifndef quickNRUPolicy_3SETb_H
#define quickNRUPolicy_3SETb_H
...
class quickNRUPolicy_3SETb : public AbstractReplacementPolicyQuick {
 public:

  quickNRUPolicy_3SETb(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickNRUPolicy_3SETb();
...
inline
quickNRUPolicy_3SETb::quickNRUPolicy_3SETb(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickNRUPolicy_3SETb::~quickNRUPolicy_3SETb()
{
}

inline 
void quickNRUPolicy_3SETb::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickNRUPolicy_3SETb::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline void quickNRUPolicy_3SETb::replacementLower(Index set, Index way)  {
}

inline 
bool quickNRUPolicy_3SETb::subSet(CacheEntryQuick *a, uint set) const
{
...
inline 
uint quickNRUPolicy_3SETb::whatSubSet(CacheEntryQuick &a) const
{
...
inline
void quickNRUPolicy_3SETb::printStats(ostream& out, char* name)  
{ int a=0;}

inline
void quickNRUPolicy_3SETb::printStats(ostream& out)  
{ int a=0;}
