...
#ifndef quickNRUPolicy_3SETe_H
#define quickNRUPolicy_3SETe_H
...
class quickNRUPolicy_3SETe : public AbstractReplacementPolicyQuick {
 public:

  quickNRUPolicy_3SETe(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickNRUPolicy_3SETe();
...
inline
quickNRUPolicy_3SETe::quickNRUPolicy_3SETe(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickNRUPolicy_3SETe::~quickNRUPolicy_3SETe()
{
}

inline 
void quickNRUPolicy_3SETe::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickNRUPolicy_3SETe::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  CacheEntryQuick *p;
  int ret[]={-1,-1,-1,-1};
  int pres[]={0,0,0,0};
...
inline void quickNRUPolicy_3SETe::replacementLower(Index set, Index way)  {
}

inline 
bool quickNRUPolicy_3SETe::subSet(CacheEntryQuick *a, uint set) const
{
...
inline 
uint quickNRUPolicy_3SETe::whatSubSet(CacheEntryQuick &a) const
{
...
inline
void quickNRUPolicy_3SETe::printStats(ostream& out, char* name)  
{ int a=0;}

inline
void quickNRUPolicy_3SETe::printStats(ostream& out)  
{ int a=0;}
