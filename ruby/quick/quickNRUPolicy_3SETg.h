...
#ifndef quickNRUPolicy_3SETg_H
#define quickNRUPolicy_3SETg_H
...
class quickNRUPolicy_3SETg : public AbstractReplacementPolicyQuick {
 public:

  quickNRUPolicy_3SETg(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickNRUPolicy_3SETg();
...
inline
quickNRUPolicy_3SETg::quickNRUPolicy_3SETg(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickNRUPolicy_3SETg::~quickNRUPolicy_3SETg()
{
}

inline 
void quickNRUPolicy_3SETg::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickNRUPolicy_3SETg::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline void quickNRUPolicy_3SETg::replacementLower(Index set, Index way)  {
}

inline 
bool quickNRUPolicy_3SETg::subSet(CacheEntryQuick *a, uint set) const
{
...
inline 
uint quickNRUPolicy_3SETg::whatSubSet(CacheEntryQuick &a) const
{
...
inline
void quickNRUPolicy_3SETg::printStats(ostream& out, char* name)  
{ int a=0;}

inline
void quickNRUPolicy_3SETg::printStats(ostream& out)  
{ int a=0;}
