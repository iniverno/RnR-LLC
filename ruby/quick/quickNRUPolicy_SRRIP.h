...
#ifndef quickNRUPolicy_SRRIP_H
#define quickNRUPolicy_SRRIP_H
...
class quickNRUPolicy_SRRIP : public AbstractReplacementPolicyQuick {
 public:

  quickNRUPolicy_SRRIP(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a, uint version);
  ~quickNRUPolicy_SRRIP();
  ...
  uint m_version;
	...
	inline void
quickNRUPolicy_SRRIP::clearStats(){}



inline
quickNRUPolicy_SRRIP::quickNRUPolicy_SRRIP(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a, uint version)
...
inline
quickNRUPolicy_SRRIP::~quickNRUPolicy_SRRIP()
{
}


inline void quickNRUPolicy_SRRIP::replacementLower(Index set, Index way)  {
...
inline 
void quickNRUPolicy_SRRIP::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickNRUPolicy_SRRIP::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline 
bool quickNRUPolicy_SRRIP::subSet(CacheEntryQuick *a, uint set) const
{
...
inline 
uint quickNRUPolicy_SRRIP::whatSubSet(CacheEntryQuick &a) const
{
...
inline 
uint quickNRUPolicy_SRRIP::countSegments(uint set, uint what) const
{
	uint aux=0;
...
inline
void quickNRUPolicy_SRRIP::printStats(ostream& out, char* name)  
{ int a=0;}

inline
void quickNRUPolicy_SRRIP::printStats(ostream& out)  
{ int a=0;}
