...
#ifndef quickNRUaPolicy_H
#define quickNRUaPolicy_H
...
class quickNRUaPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickNRUaPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickNRUaPolicy();
...
inline
quickNRUaPolicy::quickNRUaPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickNRUaPolicy::~quickNRUaPolicy()
{
}

inline 
void quickNRUaPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickNRUaPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline void quickNRUaPolicy::replacementLower(Index set, Index way)  {
}

inline 
bool quickNRUaPolicy::subSet(CacheEntryQuick *a, uint set) const
{
...
inline 
uint quickNRUaPolicy::whatSubSet(CacheEntryQuick &a) const
{
...
inline
void quickNRUaPolicy::printStats(ostream& out, char* name)  
{ int a=0;}

inline
void quickNRUaPolicy::printStats(ostream& out)  
{ int a=0;}

inline
void quickNRUaPolicy::clearStats()  
{
