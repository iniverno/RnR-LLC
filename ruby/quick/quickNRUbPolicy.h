...
#ifndef quickNRUbPolicy_H
#define quickNRUbPolicy_H
...
class quickNRUbPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickNRUbPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickNRUbPolicy();
...
inline
quickNRUbPolicy::quickNRUbPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickNRUbPolicy::~quickNRUbPolicy()
{
}

inline 
void quickNRUbPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickNRUbPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline void quickNRUbPolicy::replacementLower(Index set, Index way)  {
}

inline 
bool quickNRUbPolicy::subSet(CacheEntryQuick *a, uint set) const
{
...
inline 
uint quickNRUbPolicy::whatSubSet(CacheEntryQuick &a) const
{
...
inline
void quickNRUbPolicy::printStats(ostream& out, char* name)  
{ int a=0;}

inline
void quickNRUbPolicy::printStats(ostream& out)  
{ int a=0;}
