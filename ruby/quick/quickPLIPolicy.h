...
#ifndef quickPLIPolicy_H
#define quickPLIPolicy_H
...
class quickPLIPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickPLIPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickPLIPolicy();
...
inline
quickPLIPolicy::quickPLIPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline 
void quickPLIPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickPLIPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool quickPLIPolicy::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickPLIPolicy::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickPLIPolicy::printStats(ostream& out, char* name) 
{
...
inline
void quickPLIPolicy::printStats(ostream& out) 
{
