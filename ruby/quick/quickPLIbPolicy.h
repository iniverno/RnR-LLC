...
#ifndef quickPLIbPolicy_H
#define quickPLIbPolicy_H
...
class quickPLIbPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickPLIbPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickPLIbPolicy();
...
inline
quickPLIbPolicy::quickPLIbPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickPLIbPolicy::~quickPLIbPolicy()
{
...
inline 
void quickPLIbPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickPLIbPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool quickPLIbPolicy::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickPLIbPolicy::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickPLIbPolicy::printStats(ostream& out, char* name) 
{
...
inline
void quickPLIbPolicy::printStats(ostream& out) 
{
