...
#ifndef quickPLIcPolicy_H
#define quickPLIcPolicy_H
...
class quickPLIcPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickPLIcPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickPLIcPolicy();
...
inline
quickPLIcPolicy::quickPLIcPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickPLIcPolicy::~quickPLIcPolicy()
{
...
inline 
void quickPLIcPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickPLIcPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool quickPLIcPolicy::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickPLIcPolicy::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickPLIcPolicy::printStats(ostream& out, char* name) 
{
...
inline
void quickPLIcPolicy::printStats(ostream& out) 
{
