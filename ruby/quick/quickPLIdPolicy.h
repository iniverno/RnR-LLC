...
#ifndef quickPLIdPolicy_H
#define quickPLIdPolicy_H
...
class quickPLIdPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickPLIdPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickPLIdPolicy();
...
inline
quickPLIdPolicy::quickPLIdPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickPLIdPolicy::~quickPLIdPolicy()
{
...
inline 
void quickPLIdPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickPLIdPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool quickPLIdPolicy::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickPLIdPolicy::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickPLIdPolicy::printStats(ostream& out, char* name) 
{
...
inline
void quickPLIdPolicy::printStats(ostream& out) 
{
