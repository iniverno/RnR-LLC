...
#ifndef quickPLIePolicy_H
#define quickPLIePolicy_H
...
class quickPLIePolicy : public AbstractReplacementPolicyQuick {
 public:

  quickPLIePolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickPLIePolicy();
...
inline
quickPLIePolicy::quickPLIePolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickPLIePolicy::~quickPLIePolicy()
{
...
inline 
void quickPLIePolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickPLIePolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool quickPLIePolicy::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickPLIePolicy::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickPLIePolicy::printStats(ostream& out, char* name) 
{
...
inline
void quickPLIePolicy::printStats(ostream& out) 
{
