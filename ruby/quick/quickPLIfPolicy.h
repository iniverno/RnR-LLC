...
#ifndef quickPLIfPolicy_H
#define quickPLIfPolicy_H
...
class quickPLIfPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickPLIfPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickPLIfPolicy();
...
inline
quickPLIfPolicy::quickPLIfPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickPLIfPolicy::~quickPLIfPolicy()
{
...
inline 
void quickPLIfPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickPLIfPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool quickPLIfPolicy::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickPLIfPolicy::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickPLIfPolicy::printStats(ostream& out, char* name) 
{
...
inline
void quickPLIfPolicy::printStats(ostream& out) 
{
