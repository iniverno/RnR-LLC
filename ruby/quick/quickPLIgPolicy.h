...
#ifndef quickPLIgPolicy_H
#define quickPLIgPolicy_H
...
class quickPLIgPolicy : public AbstractReplacementPolicyQuick {
 public:

  quickPLIgPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickPLIgPolicy();
...
inline
quickPLIgPolicy::quickPLIgPolicy(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickPLIgPolicy::~quickPLIgPolicy()
{
...
inline 
void quickPLIgPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickPLIgPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool quickPLIgPolicy::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickPLIgPolicy::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickPLIgPolicy::printStats(ostream& out, char* name) 
{
...
inline
void quickPLIgPolicy::printStats(ostream& out) 
{
