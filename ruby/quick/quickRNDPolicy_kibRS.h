...
#ifndef quickRNDPolicy_kibRS_H
#define quickRNDPolicy_kibRS_H
...
class quickRNDPolicy_kibRS : public AbstractReplacementPolicyQuick {
 public:

  quickRNDPolicy_kibRS(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a);
  ~quickRNDPolicy_kibRS();
...
inline
quickRNDPolicy_kibRS::quickRNDPolicy_kibRS(Index num_sets, Index assoc, Vector<Vector<CacheEntryQuick> > *a)
...
inline
quickRNDPolicy_kibRS::~quickRNDPolicy_kibRS()
{

}

inline 
void quickRNDPolicy_kibRS::touch(Index set, Index index, Time time, uint proc){
...
inline
Index quickRNDPolicy_kibRS::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline void quickRNDPolicy_kibRS::replacementLower(Index set, Index way)  {
}

inline 
bool quickRNDPolicy_kibRS::subSet(CacheEntryQuick *a, uint subset) const
{
...
inline 
uint quickRNDPolicy_kibRS::whatSubSet(CacheEntryQuick *a) const
{
...
inline
void quickRNDPolicy_kibRS::printStats(ostream& out, char* name) 
{	
...
inline
void quickRNDPolicy_kibRS::printStats(ostream& out) 
{
