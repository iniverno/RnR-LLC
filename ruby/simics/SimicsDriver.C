...
//estas dos lineas estaban al final pero las ponemos aqui para acelerar
  ...
  //JORGE
  //revisamos el nœmero de instrucciones que ha ejecutado cada proc
  //m_accesos_user cuenta el nœmero de accesos a cada cache de instrucciones en modo usuario
