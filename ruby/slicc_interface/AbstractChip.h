...
public:
  ...
  //CRITICO!!!
  //Aqui seleccionamos el m—dulo de 
  return m_L2Cache_dram_vec[index]; };
  ...
  virtual void printTemp() const=0;
  virtual void resetTemp() const=0;
...
//  virtual void pintame(const Address& addr, int m)  = 0;
  ...
  Vector < MessageBuffer* >  m_Directory_dramToDirPrefQueue_vec;
  Vector < Dram* >  m_Directory_dram_vec;
