...
//JORGE
extern inline int isPrefetcher()
{
  return g_PREFETCHER;
}
...
extern inline int prefetchDegree()
{
  return g_PREFETCH_DEGREE;
}

extern inline int adaptDegree()
{ return g_ADAPT_DEGREE;
}

extern inline int mruInRepl()
{ return g_MRU_IN_REPL;
}
