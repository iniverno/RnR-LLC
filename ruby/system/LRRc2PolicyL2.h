...
#ifndef LRRc2PolicyL2_H
#define LRRc2PolicyL2_H
...
class LRRc2PolicyL2 : public AbstractReplacementPolicy {
  
 public:

  LRRc2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a); //SOLO PARA QUE COMPILE
  LRRc2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  ~LRRc2PolicyL2();
...
inline
LRRc2PolicyL2::LRRc2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}

inline
LRRc2PolicyL2::LRRc2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
  m_cache = a;
  //stats
...
inline
LRRc2PolicyL2::~LRRc2PolicyL2()
{
}

inline 
void LRRc2PolicyL2::touch(Index set, Index index, Time time, uint proc){
...
inline
Index LRRc2PolicyL2::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline void LRRc2PolicyL2::replacementLower(Index set, Index way) const {
}


inline
void LRRc2PolicyL2::printStats(ostream& out) const
{
