...
#ifndef LRRcPolicyL2_H
#define LRRcPolicyL2_H
...
inline 
void LRRcPolicyL2::touch(Index set, Index index, Time time, uint proc){
...
inline
Index LRRcPolicyL2::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline void LRRcPolicyL2::replacementLower(Index set, Index way) const {
}
