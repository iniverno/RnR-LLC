...
#ifndef LRRd2PolicyL2_H
#define LRRd2PolicyL2_H
...
class LRRd2PolicyL2 : public AbstractReplacementPolicy {
	mutable int trend;
  
 public:

  LRRd2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a); //SOLO PARA QUE COMPILE
  LRRd2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  ~LRRd2PolicyL2();
...
inline
LRRd2PolicyL2::LRRd2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
...
inline
LRRd2PolicyL2::LRRd2PolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
	trend = 1;
  m_cache = a;
...
inline
LRRd2PolicyL2::~LRRd2PolicyL2()
{
}

inline 
void LRRd2PolicyL2::touch(Index set, Index index, Time time){
...
inline
Index LRRd2PolicyL2::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline void LRRd2PolicyL2::replacementLower(Index set, Index way) const {
}


inline
void LRRd2PolicyL2::printStats(ostream& out) const
{
