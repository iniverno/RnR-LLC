...
#ifndef LRRfPolicyL2_H
#define LRRfPolicyL2_H
...
class LRRfPolicyL2 : public AbstractReplacementPolicy {
	mutable int trend;
  
 public:

  LRRfPolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a); //SOLO PARA QUE COMPILE
  LRRfPolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  ~LRRfPolicyL2();
...
inline
LRRfPolicyL2::LRRfPolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
...
inline
LRRfPolicyL2::LRRfPolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
	trend = 1;
  m_cache = a;
...
inline
LRRfPolicyL2::~LRRfPolicyL2()
{
}

inline 
void LRRfPolicyL2::touch(Index set, Index index, Time time){
...
inline
Index LRRfPolicyL2::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline void LRRfPolicyL2::replacementLower(Index set, Index way) const {
	m_last_ref_ptr[set][way] = g_eventQueue_ptr->getTime();
}


inline
void LRRfPolicyL2::printStats(ostream& out) const
{
