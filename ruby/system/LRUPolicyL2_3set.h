...
class LRUPolicyL2_3set : public AbstractReplacementPolicy {
  
 public:

  LRUPolicyL2_3set(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a); //SOLO PARA QUE COMPILE
  LRUPolicyL2_3set(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  ~LRUPolicyL2_3set();
...
inline
LRUPolicyL2_3set::LRUPolicyL2_3set(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}

inline
LRUPolicyL2_3set::LRUPolicyL2_3set(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
  m_cache = a;
  //stats
...
inline
LRUPolicyL2_3set::~LRUPolicyL2_3set()
{
}

inline 
void LRUPolicyL2_3set::touch(Index set, Index index, Time time){
...
inline
Index LRUPolicyL2_3set::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline
void LRUPolicyL2_3set::printStats(ostream& out) const
{
