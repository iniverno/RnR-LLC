...
#ifndef NRRaPolicyL2_H
#define NRRaPolicyL2_H

#include "AbstractReplacementPolicy.h"

/* Simple true NRU replacement policy */

class NRRaPolicyL2 : public AbstractReplacementPolicy {
 public:

  NRRaPolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  NRRaPolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a);
  ~NRRaPolicyL2();
...
inline
NRRaPolicyL2::NRRaPolicyL2(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
...
inline
NRRaPolicyL2::NRRaPolicyL2(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}
...
inline
NRRaPolicyL2::~NRRaPolicyL2()
{
}

inline 
void NRRaPolicyL2::touch(Index set, Index index, Time time, uint proc){
...
inline
Index NRRaPolicyL2::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline void NRRaPolicyL2::replacementLower(Index set, Index way) const {
}

inline 
bool NRRaPolicyL2::subSet(L2Cache_Entry *a, uint set) const
{
...
inline 
uint NRRaPolicyL2::whatSubSet(L2Cache_Entry &a) const
{
...
inline
void NRRaPolicyL2::printStats(ostream& out, char* name) const 
{ int a=0;}

inline
void NRRaPolicyL2::printStats(ostream& out)  const
{ int a=0;}
