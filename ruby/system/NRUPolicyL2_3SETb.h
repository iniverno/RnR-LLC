...
#ifndef NRUPolicyL2_3SETb_H
#define NRUPolicyL2_3SETb_H

#include "AbstractReplacementPolicy.h"

/* Simple true NRU replacement policy */

class NRUPolicyL2_3SETb : public AbstractReplacementPolicy {
 public:

  NRUPolicyL2_3SETb(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  NRUPolicyL2_3SETb(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a);
  ~NRUPolicyL2_3SETb();
...
inline
NRUPolicyL2_3SETb::NRUPolicyL2_3SETb(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
...
inline
NRUPolicyL2_3SETb::NRUPolicyL2_3SETb(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
...
inline
NRUPolicyL2_3SETb::~NRUPolicyL2_3SETb()
{
}

inline 
void NRUPolicyL2_3SETb::touch(Index set, Index index, Time time){
...
inline
Index NRUPolicyL2_3SETb::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline void NRUPolicyL2_3SETb::replacementLower(Index set, Index way) const {
}

inline 
bool NRUPolicyL2_3SETb::subSet(L2Cache_Entry *a, uint set) const
{
...
inline 
uint NRUPolicyL2_3SETb::whatSubSet(L2Cache_Entry &a) const
{
...
inline
void NRUPolicyL2_3SETb::printStats(ostream& out, char* name)  const
{ int a=0;}

inline
void NRUPolicyL2_3SETb::printStats(ostream& out)  const
{ int a=0;}
