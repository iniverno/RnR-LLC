...
#ifndef NRUPolicyL2_3SETf_H
#define NRUPolicyL2_3SETf_H

#include "AbstractReplacementPolicy.h"

/* Simple true NRU replacement policy */

class NRUPolicyL2_3SETf : public AbstractReplacementPolicy {
 public:

  NRUPolicyL2_3SETf(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  NRUPolicyL2_3SETf(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a);
  ~NRUPolicyL2_3SETf();
...
inline
NRUPolicyL2_3SETf::NRUPolicyL2_3SETf(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
...
inline
NRUPolicyL2_3SETf::NRUPolicyL2_3SETf(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}

inline
NRUPolicyL2_3SETf::~NRUPolicyL2_3SETf()
{
}

inline 
void NRUPolicyL2_3SETf::touch(Index set, Index index, Time time){
...
inline
Index NRUPolicyL2_3SETf::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline void NRUPolicyL2_3SETf::replacementLower(Index set, Index way) const {
}

inline 
bool NRUPolicyL2_3SETf::subSet(L2Cache_Entry *a, uint set) const
{
...
inline 
uint NRUPolicyL2_3SETf::whatSubSet(L2Cache_Entry &a) const
{
...
inline
void NRUPolicyL2_3SETf::printStats(ostream& out, char* name)  const
{ int a=0;}

inline
void NRUPolicyL2_3SETf::printStats(ostream& out)  const
{ int a=0;}
