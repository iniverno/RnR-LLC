...
#ifndef NRUPolicyL2_3SETj_H
#define NRUPolicyL2_3SETj_H

#include "AbstractReplacementPolicy.h"

/* Simple true NRU replacement policy */

class NRUPolicyL2_3SETj : public AbstractReplacementPolicy {
 public:

  NRUPolicyL2_3SETj(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  NRUPolicyL2_3SETj(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a);
  ~NRUPolicyL2_3SETj();
...
inline
NRUPolicyL2_3SETj::NRUPolicyL2_3SETj(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
...
inline
NRUPolicyL2_3SETj::NRUPolicyL2_3SETj(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}

inline
NRUPolicyL2_3SETj::~NRUPolicyL2_3SETj()
{
}


inline
void NRUPolicyL2_3SETj::replacementLower(Index set, Index way) const
{
...
inline 
void NRUPolicyL2_3SETj::touch(Index set, Index index, Time time){
...
inline
Index NRUPolicyL2_3SETj::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline void NRUPolicyL2_3SETj::replacementLower(Index set, Index way)  {
}



inline 
uint NRUPolicyL2_3SETj::whatSubSet(L2Cache_Entry &a) const
{
...
inline 
void NRUPolicyL2_3SETj::printSet(Index set) const {
  uint i;
  for (i=0; i < m_assoc; i++) 
  {
...
inline
void NRUPolicyL2_3SETj::printStats(ostream& out, char* name)  const
{ int a=0;}

inline
void NRUPolicyL2_3SETj::printStats(ostream& out)  const
{ int a=0;}
