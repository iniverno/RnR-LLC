...
inline
void NRUPolicyL2_3SETk::replacementLower(Index set, Index way) const
{
...
inline void NRUPolicyL2_3SETk::replacementLower(Index set, Index way)  {
}
...
inline 
void NRUPolicyL2_3SETk::printSet(Index set) const {
  uint i;
  for (i=0; i < m_assoc; i++) 
  {
