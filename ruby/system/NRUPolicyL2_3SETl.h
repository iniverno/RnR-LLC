...
#ifndef NRUPolicyL2_3SETl_H
#define NRUPolicyL2_3SETl_H

#include "AbstractReplacementPolicy.h"

/* Simple true NRU replacement policy */

class NRUPolicyL2_3SETl : public AbstractReplacementPolicy {
 public:

  NRUPolicyL2_3SETl(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  NRUPolicyL2_3SETl(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a);
  ~NRUPolicyL2_3SETl();
...
inline
NRUPolicyL2_3SETl::NRUPolicyL2_3SETl(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
...
inline
NRUPolicyL2_3SETl::NRUPolicyL2_3SETl(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}

inline
NRUPolicyL2_3SETl::~NRUPolicyL2_3SETl()
{
}


inline
void NRUPolicyL2_3SETl::replacementLower(Index set, Index way) const
{
...
inline 
void NRUPolicyL2_3SETl::touch(Index set, Index index, Time time){
...
inline
Index NRUPolicyL2_3SETl::getVictim(Index set) const {
  //  assert(m_assoc != 0);
...
inline void NRUPolicyL2_3SETl::replacementLower(Index set, Index way)  {
}



inline 
uint NRUPolicyL2_3SETl::whatSubSet(L2Cache_Entry &a) const
{
  if( !a.m_reused) return 0;
   return 1;
...
inline 
void NRUPolicyL2_3SETl::printSet(Index set) const {
  uint i;
  for (i=0; i < m_assoc; i++) 
  {
...
inline
void NRUPolicyL2_3SETl::printStats(ostream& out, char* name)  const
{ int a=0;}

inline
void NRUPolicyL2_3SETl::printStats(ostream& out)  const
{ int a=0;}
