...
inline
NRUPolicy_SRRIPb::NRUPolicy_SRRIPb(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a, uint version)
...
inline void NRUPolicy_SRRIPb::replacementLower(Index set, Index way)  {
...
inline
void NRUPolicy_SRRIPb::printStats(ostream& out)  
{ int a=0;}
