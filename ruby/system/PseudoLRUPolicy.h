...
inline void PseudoLRUPolicy::replacementLower(Index set, Index way) const {}
...
inline 
void PseudoLRUPolicy::touch(Index set, Index index, Time time, uint proc){
...
inline
Index PseudoLRUPolicy::getVictim(Index set, uint proc) const {
  //  assert(m_assoc != 0);
...
inline
void PseudoLRUPolicy::printStats(ostream& out) const
{
