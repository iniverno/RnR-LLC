...
#ifndef RNDPolicyL2_KIB_RS_H
#define RNDPolicyL2_KIB_RS_H
...
class RNDPolicyL2_KIB_RS : public AbstractReplacementPolicy {
 public:

  RNDPolicyL2_KIB_RS(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a); //SOLO PARA QUE COMPILE
  RNDPolicyL2_KIB_RS(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a);
  ~RNDPolicyL2_KIB_RS();
...
inline
RNDPolicyL2_KIB_RS::RNDPolicyL2_KIB_RS(Index num_sets, Index assoc, Vector<Vector<L1Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
}

inline
RNDPolicyL2_KIB_RS::RNDPolicyL2_KIB_RS(Index num_sets, Index assoc, Vector<Vector<L2Cache_Entry> > *a)
  : AbstractReplacementPolicy(num_sets, assoc)
{
  srand(time(NULL));
  m_cache = a;
...
inline
RNDPolicyL2_KIB_RS::~RNDPolicyL2_KIB_RS()
{
}

inline 
void RNDPolicyL2_KIB_RS::touch(Index set, Index index, Time time){
...
inline
Index RNDPolicyL2_KIB_RS::getVictim(Index set) const {
  //  assert(m_assoc != 0);
  uint i=0;
...
inline 
bool RNDPolicyL2_KIB_RS::subSet(L2Cache_Entry *a, uint subset) const
{
...
inline 
uint RNDPolicyL2_KIB_RS::whatSubSet(L2Cache_Entry *a) const
{
