...
public:
  ...
  //JORGE
  long getLoads(){return numLoads;}
  long getStores(){return numStores;}

  long getAt(){return numAt;}
  long getFetches(){return numFetches;}
  
private:
  // Private Methods
  bool tryCacheAccess(const Address& addr, CacheRequestType type, const Address& pc, AccessModeType access_mode, int size, DataBlock*& data_ptr, uint proc);
  ...
  //JORGE
  long int numLoads, numStores, numFetches, numAt;
};
