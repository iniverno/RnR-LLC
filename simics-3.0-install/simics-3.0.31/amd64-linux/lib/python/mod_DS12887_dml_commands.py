...
bit in register B.
""", filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="72")
...
""", filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="99")
...
new_command("cmos-init", cmos_init_cmd,
	    ...
	    namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="139")
...
new_command("cmos-base-mem", cmos_base_mem_cmd,
	    ...
	    namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="161")
...
new_command("cmos-extended-mem", cmos_extended_mem_cmd,
	    ...
	    namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="184")
...
new_command("cmos-floppy", cmos_floppy_cmd,
	    ...
	    namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="235")
...
new_command("cmos-hd", cmos_hd_cmd,
	    ...
	    namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="309")
...
new_command("cmos-boot-dev", cmos_boot_dev_cmd,
	    ...
	    namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="332")
...
new_command("cmos-century", cmos_century_cmd,
	    ...
	    namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="346")
...
new_command("cmos-info", cmos_info_cmd,
            ...
            namespace = modname, filename="/mp/simics-3.0/src/devices/DS12887-dml/commands.py", linenumber="400")
