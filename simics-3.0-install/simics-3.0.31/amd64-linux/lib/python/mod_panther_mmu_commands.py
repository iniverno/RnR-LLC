...
page_sizes = ("8K", "64K", "512K", "4M", "32M", "256M")
...
def chmmu_regs_cmd(obj):
    ...
    pgszi_prm = (reg_ctx_prim >> 22) & 0x7
    pgszi_nuc = (reg_ctx_prim >> 55) & 0x7
    print
    ...
    print "Page size I-TLB   - Primary:   %s" % page_sizes[pgszi_prm]
    print "Page size I-TLB   - Nucleus:   %s" % page_sizes[pgszi_nuc] 
...
def reverse_search(pa, tlb_name, tlb_dacc_regs, tlb_tags_regs):
    ...
    for i in range(len(tlb_dacc_regs)):
        ...
        mmu_sz = 1 << (13 + 3 * (((tlb_dacc_regs[i] >> 61) & 3) | ((tlb_dacc_regs[i] >> 48) & 1) << 2))
...
""" % device_name, filename="/mp/simics-3.0/src/devices/panther-mmu/commands.py", linenumber="365")
...
""", filename="/mp/simics-3.0/src/devices/panther-mmu/commands.py", linenumber="375")
...
new_command("i-tlb", chmmu_itlb_cmd,
            ...
            namespace = device_name,
            doc_with = "<%s>.d-tlb" % device_name, filename="/mp/simics-3.0/src/devices/panther-mmu/commands.py", linenumber="386")
...
""", filename="/mp/simics-3.0/src/devices/panther-mmu/commands.py", linenumber="394")
...
new_command("i-probe", chmmu_iprobe_cmd,
            ...
            namespace = device_name,
            doc_with = "<%s>.d-probe" % device_name, filename="/mp/simics-3.0/src/devices/panther-mmu/commands.py", linenumber="407")
...
""", filename="/mp/simics-3.0/src/devices/panther-mmu/commands.py", linenumber="415")
...
""", filename="/mp/simics-3.0/src/devices/panther-mmu/commands.py", linenumber="426")
