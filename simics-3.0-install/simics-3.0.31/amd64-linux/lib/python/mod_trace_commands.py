...
entire trace has been written to the file.""", filename="/mp/simics-3.0/src/extensions/trace/commands.py", linenumber="51")
...
new_command("stop", trace_stop_cmd,
            ...
            doc_with = "<base-trace-mem-hier>.start", filename="/mp/simics-3.0/src/extensions/trace/commands.py", linenumber="83")
